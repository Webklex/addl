...
spl_autoload_register(function($class) {
    ...
    if(file_exists($path)){
        ...
        $paths = array('libs/dompdf/','controller');

        foreach($paths as $p){
            if(file_exists(APP_ROOT.DIRECTORY_SEPARATOR.$p.DIRECTORY_SEPARATOR.$class.'.php')){
                include APP_ROOT.DIRECTORY_SEPARATOR.$p.DIRECTORY_SEPARATOR.$class.'.php';
            }elseif(file_exists(APP_ROOT.DIRECTORY_SEPARATOR.$p.DIRECTORY_SEPARATOR.strtolower($class).'_config.inc.php')){
                include APP_ROOT.DIRECTORY_SEPARATOR.$p.DIRECTORY_SEPARATOR.strtolower($class).'_config.inc.php';
            }
        }
    }
